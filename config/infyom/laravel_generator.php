...
return [
    ...
    */
    ...
    'namespace' => [
        ...
        'model'             => 'ApiBase\Models',

        'datatables'        => 'ApiBase\DataTables',

        'repository'        => 'ApiBase\Repositories',

        'controller'        => 'ApiBase\Http\Controllers',

        'api_controller'    => 'ApiBase\Http\Controllers\API',

        'request'           => 'ApiBase\Http\Requests',

        'api_request'       => 'ApiBase\Http\Requests\API',
    ],
